...
import { getSummaryForStudent, getPayableOptionsForStudent, validateRequestedAmount, createSubmission, getStatusForReference, attachProviderReference, getTransactionsForStudent, ensureRecurrentPaymentCode, } from "../services/paymentPlanService.js";
...
router.post("/initiate", async (req, res) => {
    try {
        const { amount, method, paymentType = "one_time" } = req.body;
        if (!amount || !method) {
